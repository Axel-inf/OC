...
def create():
    ...
    with ui.column().classes('profil-container'):
        with ui.card().classes('profil-card'):
            ...
            nom_input = ui.input('Nom', value='Dupont').props('outlined').classes('w-full q-mb-md')
            prenom_input = ui.input('Prénom', value='Jean').props('outlined').classes('w-full q-mb-md')
            email_input = ui.input('Email', value='jean.dupont@college.edu').props('outlined readonly').classes('w-full q-mb-md')
            
            # Section École
            ui.html('<div class="section-title">École</div>', sanitize=False)
            
            classe_select = ui.select(
                ['9VG1', '9VG2', '10VG1', '10VG2', '11VG1', '11VG2'],
                label='Classe',
                value='10VG1'
            ...
            maths_select = ui.select(
                ...
                value='Mathématiques renforcées'
            ).props('outlined').classes('w-full q-mb-md')
            ...
            os_input = ui.input('Option spécifique (OS)', value='Physique-Applications').props('outlined').classes('w-full q-mb-md')
            oc_input = ui.input('Option complémentaire (OC)', value='Arts visuels').props('outlined').classes('w-full q-mb-md')
            
            with ui.column().classes('w-full gap-2'):
                basic_english = ui.checkbox('Basic English', value=True)
                bilingue = ui.checkbox('Bilingue', value=False)
            
            # Section Cours complémentaires
            ...
            with ui.column().classes('w-full'):
                ...
                ui.checkbox('4-OS Ec 2').classes('q-mb-sm')
                ui.checkbox('4-OC Ec 2').classes('q-mb-sm')
                ui.checkbox('4-OC Ec 3').classes('q-mb-sm')
                ui.checkbox('4-OS Ec 3').classes('q-mb-sm')
